...
>  *H1.2* Among non-profits participating in financial rulemaking, non-profits with more assets will comment on more proposed rules.
...
> *Differential Frequency of Participation Hypothesis (H2):* Among organizations commenting on financial rulemaking, organizations with greater wealth will comment on a larger number of financial rules.
 ...
 A separate rational driving differential comment participation by wealthy organizations focuses on the concentrated costs and benefits attached to lobbying on government regulations [see broadly, @Lowi1964; @Olson1965; @Wilson1989]. Wealthy, profit-seeking organizations, such as publicly traded companies and for-profit banks, will tend to have a more narrow stake in financial regulations than organizations with more diffuse and varied constituencies, such as public interest groups. Wealthy, profit-s
A major theorized way that inequalities in organization and political participation emerge

> *Profit-motivated Participation Hypothesis (H3):* Organizations seeking profit will be more likely to comment.
...
> *Differential Lobbying Success Hypothesis (H3):* Comments from wealthier organizations will be more successful in shifting the content of agency rules.
...
> *Differential Sophistication Hypothesis (H4):* Wealthier organizations will use more technical and sophisticated language when commenting on proposed rules.

> *Dividends of Sophistication Hypothesis (H1):* Comments from wealthier organizations will be more successful in affecting the content of agency rules because of comment sophistication.  
...
6.	All organizations reporting Political Action Committee (PAC) donations or lobbying expenditures, as compiled by the Center for Responsive Politics. We then calculate average annual PAC contributions and lobbying expenditures for each organization.
...
Differences in means among for-profit Commercial Banks are significant at the .05 level in a Welch Two Sample t-test. While the differences among other types of banks (State Banks, state-chartered Savings Banks, or nonprofit savings associations) are large, there are far fewer of them and differences in average wealth among them did not have enough observations to achieve statistical significance.
...
Figure \ref{fig:opensecrets-density} shows that organizations profiled by the Center for Responsive Politics (generally, those that donate to Political Action Committees) that comment on Dodd-Frank rules are better-resourced than we would expect from a random sample of political donor organizations. This aligns with the *Differential Participation* Hypothesis (H1). The average campaign spending per 2-year cycle was \$80 thousand for donor organizations that did not comment, and the average for a donor organization that did comment on a Dodd-Frank rule was \$96 thousand. 
The difference in average contributions between organizations that comment and do not comment is significant at the 0.001 level in a Welch Two Sample t-test.
<!-- TODO NOTE: 
...
## Wealth Inequality in Lobbying Success: Variation Among Commenting Organizations
...
The top-left panel of Figure \ref{fig:dockets-percentile} shows that a large number of the banks in the top one percent of most frequent commenters (the select few that commented on more than five rules) had assets over a million dollars; many as much as 100 million. Yet, nearly all banks in the bottom 99 percentiles of most frequent commenters (most of which only commented on one rule) had assets under a million dollars.
The top-right panel of Figure \ref{fig:dockets-percentile} shows that most of the non-profits in the top one percent of most frequent commenters had assets over ten million dollars. In contrast, non-profits in the bottom 99 percentiles of most frequent commenters had assets under ten million dollars.
...
Table \@ref(tab:rules-by-assets) shows that the means between the distributions shown in Figure \ref{fig:dockets-percentile} are statistically significant for banks and campaign donors.
