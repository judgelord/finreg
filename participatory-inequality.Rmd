...
```{r opensecrets-density, fig.cap= "Political Spending of Organizations that Did and Did Not Comment", out.width="49%"}
...
knitr::include_graphics("figs/boxplot-assets-efficacy-10.png")
...
```{r assets-terms, out.width="49%",  fig.cap="Amount of Technical Language by Assets"}
## non-profits 
knitr::include_graphics(c(
  ## Nonprofits
