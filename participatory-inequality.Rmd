...
Model coefficients allow us to predict how changes in wealth produce changes in the number of rules commented on, technical terms used, and words from each comment that get adopted in the final rule.
...
modelsummary(models, caption = "Log Odds of Commenting on Any Dodd-Frank Rule by Bank Type", notes = "Reference catagory = savings associations")  %>% kableExtra::kable_styling()
    #FIXME sometimes scale_down causes an error 
```
