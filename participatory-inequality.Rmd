...
<!--TODO 
Second, we count the number of Tables and Figures. 
<!--(We measured the maximum number of tables, with large jumps excluded. For example, a document with tables 1, 2, 3, and 99 would treat 99 as an error and say there were three tables. This mostly comes from bad OCRing or documents with footnotes between the word "table" and the table number.)-->
...
### More profit-driven banks are more likely to comment than less profit-driven banks
...
<!--The bottom panel of Figure \ref{fig:dockets-percentile} shows that the majority of frequent commenters that were also campaign donors donated over \$1,000. In contrast, most campaign donors that were not frequent commenters donated less than \$1,000. -->
