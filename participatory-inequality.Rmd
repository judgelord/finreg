...
nevermind: I found it: https://banks.data.fdic.gov/docs/

I sent you a message, Devin, about the FDIC question. As far as the market cap question, the data will be from CRSP. Compustat is like background variables on companies. Market capitalization is derived from price and shares out. It is a frequently changing variable. You would have to look at a script to see where the compustat data you mention was created to see what exact time point is being used to calculate market cap. Sent from my iPad
