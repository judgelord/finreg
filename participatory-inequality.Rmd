...
```{r, mp-all-predict-quad-1, fig.cap= "Log Odds of Participating in Dodd-Frank Rulemaking by Type of Bank", out.width="70%"}
...
Commercial Banks are often large corporations managed by a board selected by shareholders and tend to serve corporations and wealthier and profit-motivated clients.
...
```{r, mpFDIC, fig.cap= "Predicted Probability of Participating in Dodd-Frank Rulemaking by Type of Bank", out.width="90%"}
#TODO Make predicted probability plots showing that all kinds of banks are more likely to comment when wealthier
#TODO CREDIT UNIONS SHOULD BE IN THIS MODEL 
knitr::include_graphics("figs/mpFDIC2-predict-1.png")
```
...
```{r mediation-acme, out.width="49%",  fig.cap= "Political Spending, Lobbying, Technical Sophistication, and Legal Sophistication as a Proposed Mediators Between Wealth and Lobbying Success"}
...
modelsummary(models, caption = "Log Odds of Commenting on Any Dodd-Frank Rule")  %>% kableExtra::kable_styling(latex_options="scale_down")
```
...
modelsummary(models, caption = "Log Odds of Commenting on Any Dodd-Frank Rule by Bank Type", notes = "Reference category = savings associations") %>% kableExtra::kable_styling(latex_options="scale_down")
```
