...
Additionally, non-profits are significantly less likely to comment than banks, even when controlling for differences in assets. 
Table \ref{tab:mp-all-table} shows the results of logit models predicting the log odds of commenting by organization type (credit union, non-profit, or bank) and total assets. Credit Unions and other non-profits are much less likely to comment than for-profit banks. 
...
## Wealth Inequality in Organizations that Lobby <!--Lobbying Frequency, Sophistication, Success--> 
