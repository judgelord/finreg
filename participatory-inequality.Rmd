...
modelsummary(models, caption = "Log Odds of Commenting on Any Dodd-Frank Rule by Bank Type", notes = 'Non-commercial banks ("thrifts") include savings associations, savings banks, and national associations.') %>% kableExtra::kable_styling(latex_options="scale_down")
```
