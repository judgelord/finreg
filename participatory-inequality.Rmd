...
<!--We use Welch t-tests to assess whether two groups have equal means.
...
We use Poisson regression to model the discrete count of rules on which an organization comments (H3), the number of words from a comment added to the final rule (H4), and the number of technical terms used in a comment (H5), as a function of wealth. 
