...
```{r, mp-all-predict-1, fig.cap= "Predicted Probability of Participating in Dodd-Frank Rulemaking by Assets and Type of Organization", out.width="70%"}
knitr::include_graphics("figs/mp-all-predict-log-1.png")
