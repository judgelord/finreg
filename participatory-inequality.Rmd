...
With technical terms as the mediator, Figure \ref{fig:mediation-terms} shows that the Average Conditional Marginal Effect is a large share (over 69 percent)  of the Total Effect of wealth on lobbying success. This suggests that the relationship between wealth and lobbying success is mediated by the use of legal and technical language. The conditional effects of technical language are statistically significant at the 0.05 level.
