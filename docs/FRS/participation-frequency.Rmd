---
title: "Participation in FRS Rulemaking"
subtitle: "Frequency"
output:
...
asset_counts %>% 
  ...
  labs(title = "Banks and Non-profits" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
asset_counts %>% 
  ...
  geom_bar() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Non-profits" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
asset_counts %>% 
  ...
  geom_bar() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Industry Associations" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
asset_counts %>% 
  ...
  labs(y = "Number of Banks",
       title = "Banks" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
asset_counts %>% 
  ...
  scale_x_log10() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Banks" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
...
asset_counts %>% 
  ...
  labs(y = "Number of Credit Unions",
       title = "Credit Unions" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
asset_counts %>% 
  ...
  scale_x_log10() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Credit Unions" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
...
asset_counts %>% 
  ...
  labs(y = "Number of Companies",
       title = "Publicly-Traded Companies" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
asset_counts %>% 
  ...
  scale_x_log10() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Publicly-Traded Companies" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
asset_counts %>% 
  ...
  geom_bar() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Campaign Donors" %>% str_c(", FRS, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       y = "Number of Organizations",
        fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
save(models, rows, 
     file = here::here("models", "FRS", "rules-by-assets.Rdata"))
```
...
d %>% 
  # filter(comment_agency == "FRS") %>% 
  # mutate(docket_id = comment_url %>% str_extract("FRS-[0-9]*-[0-9]*")) %>% 
