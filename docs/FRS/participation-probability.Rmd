...
subtitle: "Probability of Commenting on an FRS Rule" 
output:
...
(Those that "did not comment" may have commented on non-FRS Dodd-Frank rules)
...
SM = Comptroller of the Currency (FRS). National Charter and a Fed member.
...
save(models, rows, 
     file = here::here("models", "FRS", "mpFDIC.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "FRS", "mpFDIC2.Rdata"))
```
...
save(models, rows, 
     file = here::here("models", "FRS", "pr-of-comment.Rdata"))
```
...
save(models, rows, file =  here::here("models", "FRS", "mp-opensecrets.Rdata"))
...
save(models, file =  here::here("models", "FRS", "mp-opensecrets-lobbying.Rdata"))
...
save(models, rows, file = here::here("models", "FRS", "mpCompustat.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "FRS", "mpAll.Rdata"))
```
