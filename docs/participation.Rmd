...
FDIC_resources %>%
   densityplot(caption = str_c("Welch t-test of difference in means, p-vaue = ", fdic_t$p.value %>% round(3), "\nOmits foreign banks and national associations"))
```
...
FDIC_resources %>%
  ...
  labs(title = str_c("U.S. FDIC-Insured Banks, N = ", nrow(FDIC_resources)%>% prettyNum(big.mark = ",")) ,
       fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p-vaue = ", fdic_t$p.value %>% round(3), "\nOmits foreign banks and national associations")) + 
  facet_wrap("Commented", ncol = 1, scales = "free_y", strip.position = "top")+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
FDIC_resources %>%
  ...
  labs(title = "FDIC-Insured Commercial Banks",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p-vaue = ", fdic_tNM$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
FDIC_resources %>%
  ...
  labs(title = "FDIC-Insured Savings Banks",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p-vaue = ", fdic_tSB$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
scale_x_log10() + 
  labs(title = "FDIC-Insured State Banks",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p-vaue = ", fdic_tSM$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
scale_x_log10() + 
  labs(title = "FDIC-Insured Savings Associations",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p-vaue = ", fdic_tSA$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
nonprofit_resources %>% 
  ...
  densityplot(var = "assets",
              ...
              title = "Non-profits",
               x = "Assets (Thousands)",
              caption = str_c("Welch t-test of difference in means, p-vaue = ", nonprofit_t$p.value %>% round(5))) 
...
nonprofit_resources %>% 
  ...
  densityplot(var = "revenue",
              ...
              title = "Non-profits",
               x = "Revenue (Thousands)",
              caption = str_c("Welch t-test of difference in means, p-vaue = ", nonprofit_revenue_t$p.value %>% round(5))) 
...
creditunions %>% 
  ...
  densityplot(var = "assets",
              ...
              x = "Assets (Millions)",
              title = "Credit Unions", 
              caption = str_c("Welch t-test of difference in means, p-vaue = ", creditunion_t$p.value %>% round(3)))
...
opensecrets %>% 
  ...
  labs(title = str_c("Campaign Donors, N = ", nrow(opensecrets)%>% prettyNum(big.mark = ",")),
       ...
       caption = str_c("Welch t-test of difference in means, p-vaue = ", opensecrets_t$p.value %>% round(3))
       ) + 
  facet_wrap("Commented", ncol = 1, scales = "free_y", strip.position = "top")+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
...
compustat %>% 
  ...
  densityplot(var = "marketcap2",
              by = 1000000, 
              title = "Publically-traded Companies",
       x = "Market Capitalization (Millions)",
       caption = str_c("Welch t-test of difference in means, p-vaue = ", compustat_t$p.value %>% round(3))
       )
```
...
asset_counts %>% 
  ...
  labs(title = "Nonprofits" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       ...
       caption = str_c("Welch t-test, p-value = ", rules_nonprofits_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "FDIC-Insured Banks" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
       caption = str_c("Welch t-test, p-value = ", rules_fdic_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "Credit Unions" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
       caption = str_c("Welch t-test, p-value = ", rules_creditunion_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "Publicaly-Traded Companies" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       ...
       caption = str_c("Welch t-test, p-value = ", rules_compustat_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "Campaign Donors" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       ...
       caption = str_c("Welch t-test, p-value = ", rules_pac_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
