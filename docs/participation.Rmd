...
asset_counts %>% 
  ...
  scale_x_log10() + 
  labs(title = "Nonprofits",
        fill = "Frequency of\nCommenting", y = "", x = "Assets (Millions)")+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
creditunions %>% 
  ...
  labs(fill = "", x = "Assets (Millions)", 
       title = str_c("Credit Unions, N = ", nrow(creditunions)),
       fill = "", y = "")+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
creditunions %>% 
  ...
  geom_vline( aes(xintercept = mean_assets/1000000)) + 
    geom_vline( aes(xintercept = median_assets/1000000), linetype = 2) + 
  scale_x_log10() + 
  labs(title = str_c("Credit Unions, N = ", nrow(creditunions)),
       fill = "", y = "", x = "Assets (Millions)") + 
  facet_wrap("Commented", ncol = 1, scales = "free_y", strip.position = "top")+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
...
opensecrets %>% 
  ...
  labs(fill = "",  
       y = "",
       title = str_c("Campaign Donors, N = ", nrow(opensecrets)),
       x = "Mean Contribution
...
opensecrets %>% 
  ...
  geom_density(alpha = .5, color = NA) + 
  scale_x_log10() + 
  labs(title = str_c("Campaign Donors, N = ", nrow(opensecrets)),
       fill = "", 
       y = "",
...
compustat %>% 
  ...
  labs(fill = "", 
       y = "",
       title = str_c("Publically-traded Companies, N = ", nrow(compustat)),
...
compustat %>% 
  ...
  scale_x_log10() + 
  labs(title = str_c("Publically-traded Companies, N = ", nrow(compustat)),
