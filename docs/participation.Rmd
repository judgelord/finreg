...
d %<>% mutate(Org_type = org_type %>% 
                str_replace("CIK", "Publicly-traded company\n(SEC + Compustat Data)") %>% 
                str_replace("^Compustat", "Publicly-traded company\n(SEC + Compustat Data)") %>% 
...
FDIC_resources %>%
   densityplot(caption = str_c("Welch t-test of difference in means, p = ", fdic_t$p.value %>% round(3), "\nOmits foreign banks and national associations"))
```
...
FDIC_resources %>%
  ...
  labs(title = str_c("U.S. FDIC-Insured Banks, N = ", nrow(FDIC_resources)%>% prettyNum(big.mark = ",")) ,
       fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p = ", fdic_t$p.value %>% round(3), "\nOmits foreign banks and national associations")) + 
  facet_wrap("Commented", ncol = 1, scales = "free_y", strip.position = "top")+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
FDIC_resources %>%
  ...
  labs(title = "FDIC-Insured Commercial Banks",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p = ", fdic_tNM$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
FDIC_resources %>%
  ...
  labs(title = "FDIC-Insured Savings Banks",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p = ", fdic_tSB$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
scale_x_log10() + 
  labs(title = "FDIC-Insured State Banks",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p = ", fdic_tSM$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
scale_x_log10() + 
  labs(title = "FDIC-Insured Savings Associations",fill = "", y = "", x = "Assets (Thousands)",
       caption = str_c("Welch t-test of difference in means, p = ", fdic_tSA$p.value %>% round(3)))  + 
  facet_wrap("Commented",  scales = "free_y", nrow = 2)+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.position = "none")
...
nonprofit_resources %>% 
  ...
  densityplot(var = "assets",
              ...
              title = "Non-profits",
               x = "Assets (Thousands)",
              caption = str_c("Welch t-test of difference in means, p = ", nonprofit_t$p.value %>% round(5))) 
...
nonprofit_resources %>% 
  ...
  densityplot(var = "revenue",
              ...
              title = "Non-profits",
               x = "Revenue (Thousands)",
              caption = str_c("Welch t-test of difference in means, p = ", nonprofit_revenue_t$p.value %>% round(5))) 
...
creditunions %>% 
  ...
  densityplot(var = "assets",
              ...
              x = "Assets (Millions)",
              title = "Credit Unions", 
              caption = str_c("Welch t-test of difference in means, p = ", creditunion_t$p.value %>% round(3)))
...
opensecrets %>% 
  densityplot(var = "MeanContribAmount",
              ...
              x =  "Mean Contribution ($1,000s, in years contributing 2010-2017)",
       caption = str_c("Welch t-test of difference in means, p = ", opensecrets_t$p.value %>% round(3))
       )
...
#TODO CIK NOW HAS MATCHES, THEY SHOULD BE COMBINED HERE 
...
compustat %>% 
  ...
  densityplot(var = "marketcap2",
       ...
       caption = str_c("Welch t-test of difference in means, p = ", compustat_t$p.value %>% round(3))
       )
```
...
asset_counts %>% 
  ...
  labs(title = "Nonprofits" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       ...
       caption = str_c("Welch t-test of difference in means, p = ", rules_nonprofits_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "FDIC-Insured Banks" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
       caption = str_c("Welch t-test of difference in means, p = ", rules_fdic_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "Credit Unions" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
       caption = str_c("Welch t-test of difference in means, p = ", rules_creditunion_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "Publicly-Traded Companies" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       ...
       caption = str_c("Welch t-test of difference in means, p = ", rules_compustat_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
asset_counts %>% 
  ...
  labs(title = "Campaign Donors" %>% str_c(", N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       ...
       caption = str_c("Welch t-test of difference in means, p = ", rules_pac_t$p.value %>% round(3)))+
  theme(panel.grid.major.y = element_blank(),
        panel.grid.minor.y = element_blank(),
        axis.text.y = element_blank())
...
```{r mp-all-predict, fig.height=1.7, fig.width=3}

# A data frame of values at which to estimate probabilities:
values <- all %>% 
  filter(org_type == "Bank") %>% 
  tidyr::expand(assets_b = c(0, 1,2,3,4,5), org_type = "Bank") 

predicted <- predictions(mpAlli,
                         newdata = values) %>% 
