...
plot(med.terms, main = "Technical Terms as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Billion Dollars in Market Capitalization")
...
plot(med.legal, main = "Legal Citations as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Billion Dollars in Market Capitalization")
...
```{r mediation-marketcap-lobbying, fig.width=4.75, fig.height=3}
...
plot(med.cont, main = "Political Contributions as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule")

plot(med.lob, main = "Lobbying Expenditure as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Million Dollars in Total Lobbying Expenditure")
...
```{r mediation-marketcap-terms-lobbying, fig.width=4.75, fig.height=3}
...
plot(med.terms.2, main = "Technical Terms as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule")

plot(med.lob.2, main = "Lobbying Expenditure as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Million Dollars in Total Lobbying Expenditure")
...
```{r mediation-4way, fig.width=4.75, fig.height=3}
...
save(models.m4, file = here::here("models", "models.m4.Rdata"))


plot(med.terms.4, main = "Technical Terms as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Billion Dollars in Market Capitalization")


plot(med.legal.4, main = "Legal Citations as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Billion Dollars in Market Capitalization")

plot(med.cont.4, main = "Political Spending as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Billion Dollars in Market Capitalization")

plot(med.lob.4, main = "Lobbying Expenditure as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Billion Dollars in Market Capitalization")
