...
eXsplot + 
  annotate(y = 10131, x = 7705, color = "red", geom = "text", label = "Comment & Marked-up Draft Rule,\nU.S. Chamber of Commerce et al.", vjust = 1, hjust = -0.05, size = 3.5)

eXsplot + 
  scale_x_log10() +
  scale_y_log10() + 
  annotate(y = 10131, x = 7705, color = "red", geom = "text", label = "Comment & Marked-up Draft Rule,\nU.S. Chamber of Commerce et al.", vjust = 1.05, hjust = 1.05, size = 3.5)
...
eXsplot + 
  scale_x_log10() +
  scale_y_log10() + 
  annotate(y = 10131, x = 31, color = "red", geom = "text", label = "Comment & Marked-up Draft Rule,\nU.S. Chamber of Commerce et al.", vjust = 1, hjust = 1.05, size = 3.5)

# color 
eXsplot  + 
  annotate(x = 31, y = 10131, color = "red", geom = "text", label = "Comment & Marked-up Draft Rule,\nU.S. Chamber of Commerce et al.", vjust = 1, hjust = -0.05, size = 3.5)  + aes(color = org) + labs(color = "")
