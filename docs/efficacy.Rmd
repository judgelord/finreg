...
# model predicting mediator, sophistication 
model.m1.cont <- lm(TotalContribAmount ~ marketcap2,  
              data = mediation_data  %>% 
...
med.cont <- mediate(model.m1.cont, model.y.cont, sims=1000, treat = "marketcap2", 
                    mediator = "TotalContribAmount", robustSE = T, boot = T, 
                    control.value = 0.1, treat.value = 1)
...
med.lob <- mediate(model.m2.lob, model.y.lob, sims=1000, treat = "marketcap2", 
...
models <- list(model.m1.cont, model.m2.lob, model.y.cont, model.y.lob)
...
plot(med.cont, main = "Political Contributions as a Mediator Between\nAssets and Lobbying Success",       
     xlab = "Words from Comment Added to Final Rule\nPer Million Dollars in PAC Contributions")
