...
eXsplot <- efficacyXsophistication %>% # filter(efficacy > 0) %>% #FIXME 
  ...
  geom_point(y = 10131, x = 7705, color = "grey", shape = 0, size = 3) +
  geom_point(alpha = .5) + 
...
eXsplot + 
  annotate(y = 10131, x = 7705, color = "grey", geom = "text", label = "Comment & Marked-up Draft Rule from\nU.S. Chamber of Commerce et al.", vjust = 1, hjust = -0.05)
...
# color 
eXsplot + 
  annotate(y = 10131, x = 7705, color = "grey", geom = "text", 
           label = "Comment & Marked-up Draft Rule from\nU.S. Chamber of Commerce et al.", 
           vjust = 1, hjust = -0.05) + 
...
eXsplot <- efficacyXsophistication %>%  # filter(efficacy > 0) %>% #FIXME 
  ...
  labs(title = str_c("Comments on Dodd-Frank Rules, N = ", nrow(efficacyXsophistication) %>% prettyNum(big.mark = ",")),
       ...
       y = "Efficacy\n(Words From Comment\nAdded to Final Rule)",
       x = "Legal Citations in Comment") + 
  geom_point(x = 31, y = 10131, color = "grey", shape = 0, size = 3)+
  theme(legend.position = "bottom")


eXsplot  + 
  annotate(x = 31, y = 10131, color = "grey", geom = "text", label = "Comment & Marked-up Draft Rule from\nU.S. Chamber of Commerce et al.", vjust = 1, hjust = -0.05)
...
# color 
eXsplot  + 
  annotate(x = 31, y = 10131, color = "grey", geom = "text", label = "Comment & Marked-up Draft Rule from\nU.S. Chamber of Commerce et al.", vjust = 1, hjust = -0.05)  + aes(color = org) + labs(color = "")

eXsplot + 
  scale_x_log10() +
  scale_y_log10() + aes(color = org) + labs(color = "")
```
