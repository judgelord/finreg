...
#TODO CREDIT UNIONS SHOULD BE IN THIS MODEL 
knitr::include_graphics("figs/only-np-sep-mp-all-predict-quad-1.png")
knitr::include_graphics("figs/np-sep-mp-all-predict-quad-1.png.png")
```
...
modelsummary(models, caption = "Poisson Models of Lobbying Success by Comment Sophistication", notes = "") %>% kableExtra::kable_styling(latex_options="scale_down")
```
