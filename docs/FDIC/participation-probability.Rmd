...
subtitle: "Probability of Commenting on an FDIC Rule" 
output:
...
(Those that "did not comment" may have commented on non-FDIC Dodd-Frank rules)
...
SM = Comptroller of the Currency (FDIC). National Charter and a Fed member.
...
save(models, rows, 
     file = here::here("models", "FDIC", "mpFDIC.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "FDIC", "mpFDIC2.Rdata"))
```
...
save(models, rows, 
     file = here::here("models", "FDIC", "pr-of-comment.Rdata"))
```
...
save(models, rows, file =  here::here("models", "FDIC", "mp-opensecrets.Rdata"))
...
save(models, file =  here::here("models", "FDIC", "mp-opensecrets-lobbying.Rdata"))
...
save(models, rows, file = here::here("models", "FDIC", "mpCompustat.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "FDIC", "mpAll.Rdata"))
```
