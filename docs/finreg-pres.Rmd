...
Among participants, 💰 $\rightarrow$ sophistication (e.g., lawyers) $\rightarrow$ lobbying success

- Wealthy organizations submit more sophisticated comments (legally & technically)
--
...
##  💰 $\rightarrow$ seat at the table, especially if profit-motivated
...
```{r mp-pr-bank, fig.cap= "", out.width="70%"}
knitr::include_graphics("figs/pr-bank.png")
```
...
```{r mediation-terms, out.width="50%",  fig.cap= "Technical Language as a Proposed Mediator Between Wealth and Lobbying Success"}
