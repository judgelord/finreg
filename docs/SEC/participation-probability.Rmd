...
subtitle: "Probability of Commenting on an SEC Rule" 
output:
...
(Those that "did not comment" may have commented on non-SEC Dodd-Frank rules)
...
SM = Comptroller of the Currency (SEC). National Charter and a Fed member.
...
save(models, rows, 
     file = here::here("models", "SEC", "mpFDIC.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "SEC", "mpFDIC2.Rdata"))
```
...
save(models, rows, 
     file = here::here("models", "SEC", "pr-of-comment.Rdata"))
```
...
save(models, rows, file =  here::here("models", "SEC", "mp-opensecrets.Rdata"))
...
save(models, file =  here::here("models", "SEC", "mp-opensecrets-lobbying.Rdata"))
...
save(models, rows, file = here::here("models", "SEC", "mpCompustat.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "SEC", "mpAll.Rdata"))
```
