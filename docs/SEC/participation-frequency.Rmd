---
title: "Participation in SEC Rulemaking"
subtitle: "Frequency"
output:
...
asset_counts %>% 
  ...
  labs(title = "Banks and Non-profits" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
asset_counts %>% 
  ...
  geom_bar() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Non-profits" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
```{r ind-assoc-rules, eval=FALSE, fig.width=4, fig.height= 2, out.width= "50%"}
...
asset_counts %>% 
  ...
  geom_bar() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Industry Associations" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
```{r fdic-rules, eval=FALSE, fig.width=4,  fig.height= 2,out.width= "50%"}
asset_counts <- d %>% 
  mutate(assets = ASSET) %>% 
  filter(assets > 10) %>%
  distinct(org_name, docket_id, assets) %>% 
...
asset_counts %>% 
  ...
  labs(y = "Number of Banks",
       title = "Banks" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
asset_counts %>% 
  ...
  scale_x_log10() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Banks" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
...
asset_counts %>% 
  ...
  labs(y = "Number of Credit Unions",
       title = "Credit Unions" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
asset_counts %>% 
  ...
  scale_x_log10() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Credit Unions" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       y = "", x = "Assets (Millions)",
...
asset_counts %>% 
  ...
  labs(y = "Number of Companies",
       title = "Publicly-Traded Companies" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
asset_counts %>% 
  ...
  scale_x_log10() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Publicly-Traded Companies" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
...
asset_counts %>% 
  ...
  geom_bar() + 
  scale_fill_viridis_d(begin = .3, end = .9) +  
  labs(title = "Campaign Donors" %>% str_c(", SEC, N = ", nrow(asset_counts) %>% prettyNum(big.mark = ",")),
       y = "Number of Organizations",
        fill = "Frequency of\nCommenting",
       x = "Number of Dodd-Frank Rules") #+ scale_y_log10()
...
save(models, rows, 
     file = here::here("models", "SEC", "rules-by-assets.Rdata"))
```
...
d %>% 
  # filter(comment_agency == "SEC") %>% 
  # mutate(docket_id = comment_url %>% str_extract("SEC-[0-9]*-[0-9]*")) %>% 
