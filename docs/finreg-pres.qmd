...
Your feedback will be helpful in the direction we take this. 
...
> [Commercial banks]() were [four]() times more likely to comment on a Dodd-Frank rule than the average nonprofit [aavings association](), [six]() times more likely to comment than the average [credit union](), and [60]() times more likely to comment than the average [nonprofit](). 
...
- Comments from wealthy organizations are easier to accommodate
...
- the wealthy have greater stakes (?)

- This is good, actually. Wealthier organizations "represent" more people (?)

  - Nonprofit volunteers? members vs. memberless? (❌)
...
- Setup & theoretical contribution
- Thoughts on matching
- Dealing with relevance/stakes conceptually
- Omitted variables
