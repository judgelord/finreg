...
subtitle: "Probability of Commenting on an NCUA Rule" 
output:
...
(Those that "did not comment" may have commented on non-NCUA Dodd-Frank rules)
...
SM = Comptroller of the Currency (NCUA). National Charter and a Fed member.
...
save(models, rows, 
     file = here::here("models", "NCUA", "mpFDIC.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "NCUA", "mpFDIC2.Rdata"))
```
...
save(models, rows, 
     file = here::here("models", "NCUA", "pr-of-comment.Rdata"))
```
...
save(models, rows, file =  here::here("models", "NCUA", "mp-opensecrets.Rdata"))
...
save(models, file =  here::here("models", "NCUA", "mp-opensecrets-lobbying.Rdata"))
...
save(models, rows, file = here::here("models", "NCUA", "mpCompustat.Rdata"))
```
...
save(models, rows,
     file = here::here("models", "NCUA", "mpAll.Rdata"))
```
