...
d <- match_data_clean  |> filter(comment_agency == "CFPB")
...
ind_assoc_resources %>% 
  ...
  densityplot(var = "assets",
              by = 1000,
              title = "Industry Associations (CFPB Only)",
               x = "Assets (Thousands)",
...
opensecrets %>% 
  densityplot(var = "MeanContribAmount",
              by = 1000,
              title = "Campaign Donors (CFPB Only)",
...
opensecrets %>% 
  densityplot(var = "MeanLobbyingAmount",
              by = 1000,
              title = "Lobbying Spending (CFPB Only)",
...
compustat %>% 
  ...
  densityplot(var = "marketcap2",
              by = 1000000, 
              title = "Publicly-traded Companies (CFPB Only)",
...
Continued at judgelord.github.io/finreg/CFPB/participation-probability.html and judgelord.github.io/finreg/CFPB/participation-frequency.html
