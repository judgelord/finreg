# Inequality in Agency Rulemaking: Methods and Evidence From Financial Regulation 

# [PDF](https://github.com/judgelord/finreg/blob/main/docs/participatory-inequality.pdf)

The above linked PDF is generated by `participatory-inequality.qmd`, which requires 
- /code/`setup.R`
- /figs/
- /models/
- /data/
