...
The existing inequality literature would have predicted America's wealthiest business leaders and allocators of capital would direct their lobbying at congressional *lawmaking.* Instead, these business leaders and their lobbyists were targeting the *rulemaking* implementing the Dodd-Frank Wall Street Reform and Consumer Protection Act of 2010 (hereafter Dodd-Frank) [see, e.g., @Protess2017; @Radnofsky2017] -->
...
<!-- (Chris 2022-07-23) Can we think about using the term Commenting [x] so that each time we talk about these, it's more like
Commenting banks, non-profits, and credit unions have much greater assets on average than similar non-commenting organizations. -->
...
<!-- (Angelo 7/14/2022: moved mentions of legal expertise to appendix.) -->
...
<!-- (Chris 2022-07-23:Can we introduce the agencies in the second sentence so that figure captions can just use the abbreviations?) -->
...
In contrast, in measuring sophistication, we aim to assess how much the commenter utilizes expertise to engage in technical policy debates. Here, attaching a marked-up version of the proposed rule captures the underlying concept of sophistication. Thus, our counts of technical banking terms do not exclude the text of the draft rule. Even if they are the agency's terms, engaging with the agency's texts indicates sophistication.

<!-- (Angelo 7/14/22: Is there a technical terms example, if we're moving the legal term analysis to the appendix?) -->
<!-- For example, the comment with the most bluebook/legal terms from a bank contained a 4-page comment and 112 pages of attachments, 105 of which were the full proposed rule. These 105 pages were excluded from our measure of text reuse but included in the legal and banking terms count.  -->
...
<!-- (Angelo 7/15: Added broad methods exposition... thought it fit better at the end as it's own little subsection?) -->
...
Resulting model coefficients allow us to predicatively estimate how changes in an organization's assets produce changes in that organization's probability and odds of offering a comment on a rule.
...
Because our outcomes in the three hypotheses above are discrete counts, poisson modeling is an approriate method to test them.
Model coefficients will then allow us to predict how changes in wealth produce changes in the number of rules commented on, words from comment into the final rule, and technical terms used.
<!-- (Chris 2022-07-23: Can we make Poisson ... to test them. a footnote? Always seems a bit odd when that type of thing is in the text, as it's like a reminder more than a revelation.) -->
...
<!-- (Chris 2022-07-23: I think it's better to say that Commericial Banks difference is not statistically significant at the 0.05 level here.-->
...
<!-- (Chris 2022-07-23: I think it is best to pick a level and stick to it.) -->
...
lobbying success is the dependent variable in the main models, and the number of technical terms are the proposed mediators (the dependent variable in the mediator model). 
