...
cm = c("ASSET" = "Assets",
       ...
       "assets_b2" = "Assets^2 (in Billions)",
       "log(assets_b + 1)" = "Log Assets (in Billions)",
       "log(assets_b + 1):org_typeCredit union" = "Log Assets (in Billions) x Credit Union",
       "org_typeCredit union:assets_b2" = "Assets^2 (in Billions) x Credit Union",
       "log(assets_b + 1):org_typeNon-profit" = "Log Assets (in Billions) x Nonprofit",
       "org_typeNon-profit:assets_b2" = "Assets^2 (in Billions) x Nonprofit",
