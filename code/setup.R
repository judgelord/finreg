...
cm = c("ASSET" = "Assets",
       ...
       "org_typeCredit union:assets_b2" = "Assets^2 x Credit Union",
       "log(assets_b + 1):org_typeNon-profit" = "Log Assets x Nonprofit",
       "org_typeNon-profit:assets_b2" = "Assets^2 x Nonprofit",
