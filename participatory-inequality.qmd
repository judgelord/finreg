...
Our data cover over eight hundred regulatory actions (part of `r n_rules` rulemaking processes) across seven agencies.^[We define a regulatory action as the publication of a proposed or final rule by one agency. We count a joint rule issued by the SEC and the Federal Reserve as two regulatory actions.] 
<!--2. METHODS-->
