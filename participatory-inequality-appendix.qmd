...
@fig-mp-opensecrets shows the results of logit models predicting the log odds of commenting on a Dodd-Frank rule by each organization's average political action committee contributions (model 4 in @tbl-mp-opensecrets-table). These models show that organizations that spend more on political campaigns are significantly more likely to comment.
